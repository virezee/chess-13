  ...
  return (
    <section>
      ...
      <p className='mt-3 text-[15px] leading-relaxed text-ink-dim'>
        ...
        is captured. The square it lands on must be empty.
      </p>
      <p className='mt-2.5 text-[15px] leading-relaxed text-ink-dim'>
        What is different is how it kills: a Mage never captures a piece by moving onto it. Instead
        it blasts everything standing next to it.
      </p>
